...
[![Stars](https://img.shields.io/github/stars/layumi/Person_reID_baseline_pytorch)](https://github.com/layumi/Person_reID_baseline_pytorch/stargazers)
...
**16 Feb 2026** We add support for the latest DinoV3 by using `--use_dino`.  
...
| [DinoV3-base (all tricks+Circle 256x128)] | 93.08% | 82.10% | `python train.py --use_dino --name dino_p0.5_circle_w5_b32_lr0.04  --lr 0.04 --batch 32 --erasing_p 0.5 --circle --warm_epoch 5; python test.py --name   dino_p0.5_circle_w5_b32_lr0.04 --batch 32`|
