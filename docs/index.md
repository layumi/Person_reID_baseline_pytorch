...
## Table of contents
* [Features](https://github.com/layumi/Person_reID_baseline_pytorch/features)
* [Some News](https://github.com/layumi/Person_reID_baseline_pytorch/some-news)
* [Trained Model](https://github.com/layumi/Person_reID_baseline_pytorch/trained-model)
* [Prerequisites](https://github.com/layumi/Person_reID_baseline_pytorch/prerequisites)
* [Getting Started](https://github.com/layumi/Person_reID_baseline_pytorch/getting-started)
    * [Installation](https://github.com/layumi/Person_reID_baseline_pytorch/installation)
    * [Dataset Preparation](https://github.com/layumi/Person_reID_baseline_pytorch/dataset--preparation)
    * [Train](https://github.com/layumi/Person_reID_baseline_pytorch/train)
    * [Test](https://github.com/layumi/Person_reID_baseline_pytorch/test)
    * [Evaluation](https://github.com/layumi/Person_reID_baseline_pytorch/evaluation)
* [Tips for training with other datasets](https://github.com/layumi/Person_reID_baseline_pytorch/tips)
* [Citation](https://github.com/layumi/Person_reID_baseline_pytorch/citation)
* [Related Repos](https://github.com/layumi/Person_reID_baseline_pytorch/related-repos)
